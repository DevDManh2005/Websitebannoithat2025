...
return new class extends Migration
{
    ...
    {
        // Thêm 'shipped_to_shipper' vào danh sách enum
    ...
    public function down(): void
    {
        ...
        DB::statement("ALTER TABLE orders MODIFY COLUMN status ENUM('pending','processing','shipping','delivered','cancelled') NOT NULL DEFAULT 'pending'");
    }
};