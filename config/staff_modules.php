...
return [
    // Kinh doanh
    'orders'          => ['label' => 'Đơn hàng',            'icon' => 'ri-bill-line',            'index' => 'staff.orders.index'],
    'products'        => ['label' => 'Sản phẩm',            'icon' => 'ri-price-tag-3-line',     'index' => 'staff.products.index'],
    'inventories'     => ['label' => 'Tồn kho',             'icon' => 'ri-archive-2-line',       'index' => 'staff.inventories.index'],
    'categories'      => ['label' => 'Danh mục',            'icon' => 'ri-folder-2-line',        'index' => 'staff.categories.index'],
    'brands'          => ['label' => 'Thương hiệu',         'icon' => 'ri-vip-crown-line',       'index' => 'staff.brands.index'],
    'suppliers'       => ['label' => 'Nhà cung cấp',        'icon' => 'ri-truck-line',           'index' => 'staff.suppliers.index'],
    ...
    'settings'        => ['label' => 'Cấu hình',            'icon' => 'ri-settings-3-line',      'index' => 'staff.settings.index'],
    'permissions'     => ['label' => 'Quyền',               'icon' => 'ri-key-2-line',           'index' => 'staff.permissions.index'],
    'route-permissions'=>['label' => 'Route ↔ Quyền',       'icon' => 'ri-git-merge-line',       'index' => 'staff.route-permissions.index'],
];
