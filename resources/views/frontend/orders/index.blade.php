...
@section('content')
    ...
    <div class="container my-5">
        <div class="row g-4">
            {{-- =================== LEFT MENU =================== --}}
            <div class="col-lg-3">
                <div class="profile-menu card-glass shadow-elevated rounded-4" data-aos="fade-right">
                    <div class="p-4">
            ...
            {{-- =================== RIGHT CONTENT =================== --}}
            <div class="col-lg-9">
                <div class="card-glass shadow-elevated rounded-4" data-aos="fade-left" data-aos-delay="100">
                    ...
                    @if($orders->hasPages())
                        <div class="card-footer card-glass border-0 pt-3">
...
<style>
    ...
    /* Profile menu */
    .profile-avatar { width: 100px; height: 100px; object-fit: cover; border: 4px solid var(--card); box-shadow: 0 0 15px rgba(0,0,0,0.12); }
    .profile-menu .list-group-item { border: none; padding: .9rem 1.1rem; font-weight: 500; color: var(--text); background: transparent; border-radius: .6rem; }
    .profile-menu .list-group-item + .list-group-item { margin-top:.25rem; }
    .profile-menu .list-group-item.active { background-color: var(--brand); color: var(--card); }
    .profile-menu .list-group-item:not(.active):hover { background: var(--sand); }

    /* Order status pills */
    .nav-pills .nav-link { color: var(--muted); font-weight: 500; white-space: nowrap; }
    .nav-pills .nav-link.active { background-color: var(--brand); color: var(--card); box-shadow: 0 2px 6px rgba(var(--brand-rgb),.25); }

    /* Order items */
    .order-item { background: var(--card); transition: background .2s ease; }
    .order-item:not(:first-child) { border-top: 1px solid var(--sand) !important; }
    .order-item:hover { background: var(--bg); }
    .order-hash { border-radius: .6rem; }
    .order-item .text-brand { color: var(--brand) !important; }
