                ...
                <div class="d-flex flex-wrap justify-content-between align-items-center gap-3">
                    <div>
                        <div class="d-flex align-items-center gap-2">
                            <span class="badge badge-soft-brand fw-semibold rounded-pill">Mã đơn: #{{ $order->order_code }}</span>
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-5">
                                    ...
                                    @if(!$isPaid && $isOnline && in_array($order->status, ['pending','processing']))
                                        <a href="{{ route('payment.vnpay.create', $order) }}" class="btn btn-brand w-100 rounded-pill mt-3">
                            ...
                            <form action="{{ route('orders.update-address', $order) }}" method="POST" id="update-address-form">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control form-control-modern" name="receiver_name" value="{{ old('receiver_name', optional($order->shipment)->receiver_name) }}" required>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="phone" class="form-label">Số điện thoại</label>
                                        <input type="text" class="form-control form-control-modern" name="phone" value="{{ old('phone', optional($order->shipment)->phone) }}" required>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-select form-control-modern" id="province_id_edit" name="province_id" required></select>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-select form-control-modern" id="district_id_edit" name="district_id" required></select>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-select form-control-modern" id="ward_code_edit" name="ward_code" required></select>
                                    </div>
                                    <div class="col-12">
                                        <label for="address" class="form-label">Địa chỉ cụ thể (số nhà, tên đường...)</label>
                                        <input type="text" class="form-control form-control-modern" id="address_edit" name="address" value="{{ old('address', optional($order->shipment)->address) }}" required placeholder="Ví dụ: 123 Nguyễn Văn Linh">
                                    </div>
                                </div>
...
.text-brand { color: #A20E38 !important; }
.btn-brand {
    background: #A20E38;
    color: #fff;
...
.text-danger { color: #A20E38 !important; }
.btn-primary {
