...
@php
     ...
     *  - $repliesMap (mảng map parentId => [replies])
     *  - $canReply (bool)
     *  - $currentUserId (int|null)
     *  - $replyUrl (string) // không bắt buộc nữa
     */
                    ...
                    <div class="collapse mt-2" id="edit-review-{{ $review->id }}">
                        <form method="POST" action="{{ route('reviews.update', $review) }}">
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <a class="btn btn-sm btn-light" data-bs-toggle="collapse" href="#edit-review-{{ $review->id }}">Hủy</a>
                            </div>
                        </form>
                    </div>
                @endif
