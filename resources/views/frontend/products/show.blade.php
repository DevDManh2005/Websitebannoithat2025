                        ...
                        <div class="swiper-wrapper">
                            @forelse($product->images as $image)
                                <div class="swiper-slide">
                                    <img src="{{ $image->image_url_path }}" class="w-100 h-100 object-fit-cover" alt="{{ $product->name }}">
                                </div>
                            @empty
                                <div class="swiper-slide">
                                    <img src="https://placehold.co/800x800?text=No+Image" class="w-100 h-100 object-fit-cover" alt="No Image Available">
                                </div>
                            @endforelse
                        </div>
