{{-- File này chứa các nút hành động: Tìm kiếm, Tài khoản, Wishlist, Giỏ hàng --}}
{{-- Biến $iconColor được truyền vào từ header cha ('text-white' hoặc '') --}}
    ...
    <a href="{{ route('wishlist.index') }}" class="nav-link ms-3 position-relative" aria-label="Yêu thích">
        ...
        @auth
            <span id="wishlist-count"
                  ...
                  style="font-size: 0.6em; {{ $sharedWishlistItemCount > 0 ? '' : 'display: none;' }}">
