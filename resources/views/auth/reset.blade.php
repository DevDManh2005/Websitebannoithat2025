      ...
      <form method="POST" action="{{ route('reset.password') }}" class="needs-validation" novalidate>
        ...
        <div class="mb-3">
          ...
          <div class="input-group input-group-lg rounded-4 shadow-sm-soft">
            ...
            <input type="email" id="emailInput" name="email"
                   ...
                   placeholder="ban@gmail.com" required
        ...
        <div class="mb-3">
          ...
          <div class="input-group input-group-lg rounded-4 shadow-sm-soft">
            ...
            <button type="button" id="togglePwd" class="input-group-text bg-white border-start-0 eye-btn"><i class="bi bi-eye"></i></button>
          </div>
        ...
        <div class="mb-3">
          ...
          <div class="input-group input-group-lg rounded-4 shadow-sm-soft">
            ...
            <button type="button" id="togglePwd2" class="input-group-text bg-white border-start-0 eye-btn"><i class="bi bi-eye"></i></button>
          </div>
        </div>
...
{{-- CSS GIỮ NGUYÊN --}}
<style>
.shadow-sm-soft{ box-shadow:0 6px 18px rgba(16,24,40,.06); } .btn-gradient{ background:linear-gradient(135deg,#ff4d6d,#c1126b); color:#fff; border:none; } .btn-gradient:hover{ filter:brightness(.98); color:#fff; } .eye-btn{ cursor:pointer; } .reg-hero{ min-height:480px; } .reg-hero-overlay{ position:absolute; inset:0; background:radial-gradient(120% 60% at 100% 0, rgba(255,255,255,.1), rgba(0,0,0,.35)); } .form-control:focus{ box-shadow:0 0 0 .2rem rgba(193,18,107,.15); } .otp-group{ display:flex; gap:10px; } .otp-box{width:48px; height:56px; text-align:center; font-size:22px; border-radius:12px;border:1px solid #dee2e6; outline:none; transition:.2s; box-shadow:0 6px 18px rgba(16,24,40,.06); } .otp-box:focus{ border-color:#c1126b; box-shadow:0 0 0 .2rem rgba(193,18,107,.15); }
</style>
@endpush
