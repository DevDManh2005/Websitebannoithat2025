    ...
    <div class="row g-4 align-items-center">
      ...
      @enderror
        ...
        <div class="mb-2">
          ...
          <a class="small text-decoration-none" href="{{ route('forgot.form') }}">Quên mật khẩu?</a>
          </div>
          ...
          <button class="input-group-text bg-transparent border-start-0 eye-btn" type="button" id="togglePassword"
      ...
      @enderror
        ...
        {{-- Submit --}}
        <button type="submit"
          class="btn btn-lg btn-primary-gradient w-100 d-flex align-items-center justify-content-center gap-2">
...
@push('styles')
  ...
  <style>
    ...
    align-items: center;
    padding-block: 48px;
    background: radial-gradient(1200px 600px at -10% -10%, #f8e8ff 0%, transparent 60%), radial-gradient(900px 500px at 110% 120%, #e6f7ff 0%, transparent 60%), linear-gradient(180deg, #ffffff, #f8fafc);
    }
    ...
    height: 12px;
    border-radius: 50%;
    background: linear-gradient(135deg, #ff54a6, #d1006f);
    box-shadow: 0 0 0 4px rgba(255, 84, 166, .2);
    }
    ...
    .fancy-input:focus-within .form-control,
    .fancy-input:focus-within .input-group-text {
    border-color: #b83280;
    ...
    position: absolute;
    inset: 0;
    background: radial-gradient(800px 240px at 40% -10%, rgba(255, 255, 255, .7), transparent 55%);
    pointer-events: none;
    }
