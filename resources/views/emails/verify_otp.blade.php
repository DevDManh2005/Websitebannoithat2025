        ...
        <table class="container" role="presentation" width="600" cellpadding="0" cellspacing="0" style="width:600px;max-width:600px;background:#ffffff;border-radius:12px;overflow:hidden;">
              ...
              <table width="100%">
                <tr>
                  <td style="font-size:18px;font-weight:700;">
                    {{ config('app.name', 'Website của bạn') }}
                  </td>
          ...
          <tr>
            <td class="px" style="padding:24px 28px;">
              <h2 style="margin:0 0 8px;font-size:20px;">Chào bạn,</h2>
              <p style="margin:0 0 12px;font-size:14px;line-height:1.6;">
                Cảm ơn bạn đã đăng ký tài khoản. Vui lòng dùng <strong>mã OTP</strong> bên dưới để xác minh địa chỉ email của bạn.
              </p>
              ...
              {{-- Nếu có link xác minh trực tiếp, truyền $verifyUrl và mở phần này --}}
              {{-- 
              <div style="margin-top:16px;" align="center">
                <a class="btn" href="{{ $verifyUrl ?? '#' }}" 
                   style="display:inline-block;background:#10b981;color:#ffffff;text-decoration:none;padding:12px 18px;border-radius:8px;font-weight:700;">
                  Xác minh ngay
                </a>
              </div>
              --}}
              ...
              <p style="margin:0;font-size:12px;color:#6b7280;">
                Nếu bạn không yêu cầu, hãy bỏ qua email này. Đừng chia sẻ mã OTP cho bất kỳ ai.
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td class="px" style="padding:16px 28px 28px;">
              ...
              <p style="margin:0;font-size:12px;color:#6b7280;">
                Email được gửi tự động từ {{ config('app.name', 'Website của bạn') }} – vui lòng không trả lời trực tiếp.
                Cần hỗ trợ? Liên hệ 
                <a href="mailto:{{
              ...
              <p style="margin:8px 0 0;font-size:12px;color:#9ca3af;">
                © {{ date('Y') }} {{ config('app.name', 'Website của bạn') }}. All rights reserved.
              </p>
            </td>
          </tr>
        </table>
