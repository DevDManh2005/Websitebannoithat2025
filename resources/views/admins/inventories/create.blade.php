        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.inventories.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('address') is-invalid @enderror" id="address" name="address" value="{{ old('address') }}" placeholder="Ví dụ: 123 Đường ABC, Quận Sơn Trà, Đà Nẵng">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Kích hoạt lần đầu khi tải trang để xử lý trường hợp có old()
