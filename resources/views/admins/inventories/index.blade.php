...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="filter-bar mb-3">
            ...
            {{-- Bộ lọc đơn giản: q = tên/sku, low = tồn thấp (0/<=5) --}} <form class="row g-2 mt-2" method="get"
        ...
        $groups = ($inventories instanceof \Illuminate\Pagination\AbstractPaginator ? collect($inventories->items()) :
        collect($inventories))
        ->groupBy('product_id');
        @endphp --}}
                        ...
                        <tbody>
                            @forelse($products as $product)
                                @php
                                    ...
                                    $thumb = $product->thumbnail_url; // Giả sử bạn có accessor này trong Model Product
                                   ...
                                   <td class="text-muted">#{{ $product->id }}</td>
                                    ...
                                    <td class="text-truncate">
                                        <a class="fw-semibold text-decoration-none"
                                           href="{{ route('admin.products.edit', $product->id) }}" title="{{ $product->name }}">
                                            {{ $product->name }}
                                        </a>
