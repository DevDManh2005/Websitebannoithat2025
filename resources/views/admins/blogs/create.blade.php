...
@php
    ...
    function renderCategoryOptions($categories, $level = 0, $prefix = '') {
        ...
        foreach ($categories as $cat) {
            ...
            $output .= '<option value="' . $cat->id . '">' . $prefix . $indent . $cat->name . '</option>';
        ...
        <div class="card card-soft">
          ...
          <div class="card-body">
            <div class="mb-3">
              ...
              <input type="text" name="title" id="titleInput" class="form-control @error('title') is-invalid @enderror" value="{{ old('title') }}" required>
            ...
            <div class="mb-3">
              ...
              <textarea name="excerpt" rows="4" class="form-control @error('excerpt') is-invalid @enderror">{{ old('excerpt') }}</textarea>
...
<script>
  ...
  // Thumbnail preview với fade-in
  const $thumbInput = document.getElementById('thumbInput');
  const $thumbPreview = document.getElementById('thumbPreview');
  $thumbInput?.addEventListener('change', e => {
    const f = e.target.files?.[0];
    if (!f) { $thumbPreview.classList.remove('show'); $thumbPreview.src=''; return; }
    const reader = new FileReader();
    reader.onload = ev => { $thumbPreview.src = ev.target.result; $thumbPreview.classList.add('show'); };
