...
<form action="{{ route('admin.blog-categories.store') }}" method="POST" enctype="multipart/form-data" class="row g-4">
  ...
  <div class="col-lg-8">
    <div class="card p-3">
      ...
      <div class="mb-3">
        ...
        <input type="text" name="name" value="{{ old('name') }}" class="form-control" oninput="syncSlug(this.value)" required>
      </div>
  ...
  <div class="col-lg-4">
    <div class="card p-3">
      ...
      <button type="submit" class="btn btn-primary w-100"><i class="bi bi-save me-1"></i> Lưu</button>
    </div>
  </div>
</form>
@endsection
